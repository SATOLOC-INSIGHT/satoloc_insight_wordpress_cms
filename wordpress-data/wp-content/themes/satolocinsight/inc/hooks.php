 ...
 * @return mixed
 */
function satoloc_approver_columns($column_array)
{
	$column_array['approver'] = 'Approver';
	return $column_array;
}
add_filter('manage_posts_columns', 'satoloc_approver_columns');
add_filter('manage_pages_columns', 'satoloc_approver_columns');
 ...
 */
function satoloc_populate_approver_columns($column_name, $post_id)
{
	switch ($column_name) {
		case 'approver':
...
add_action('manage_posts_custom_column', 'satoloc_populate_approver_columns', 10, 2);
add_action('manage_pages_custom_column', 'satoloc_populate_approver_columns', 10, 2);
 ...
 */
function satoloc_bulk_edit_save($post_id)
{
...
add_action('save_post', 'satoloc_bulk_edit_save');
 ...
 */
function satoloc_pro_add_quick_edit_custom_box($column_name, $post_type)
{
...
add_action('quick_edit_custom_box', 'satoloc_pro_add_quick_edit_custom_box', 10, 2);
add_action('bulk_edit_custom_box', 'satoloc_pro_add_quick_edit_custom_box', 10, 2);
